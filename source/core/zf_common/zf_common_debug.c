...
{
//    const pwm_channel_enum pin_list[] = 
//    {
//    };
...
#else
/* GCC 工具链要求 fputc 签名与 stdio.h 一致：int fputc(int, FILE*) */
...
void debug_init (void)
{
    ...
    uart_set_interrupt_config(DEBUG_UART_INDEX, UART_INTERRUPT_CONFIG_RX_ENABLE);
	  interrupt_set_priority(DEBUG_UART_PRIORITY, DEBUG_UART_PRIORITY0_7);        // 设置对应 UART_INDEX 的中断优先级为 0
